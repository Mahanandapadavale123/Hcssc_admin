...
use App\Http\Controllers\Admin\TPUsersController;
use App\Http\Controllers\Auth\LoginController;
use App\Http\Controllers\Auth\UserAuthController;
use App\Http\Controllers\Admin\EndUserAdditionalDataController;
use App\Http\Controllers\Admin\EndUserChargeController;
use App\Http\Controllers\Admin\MasterEquipmentController;
use App\Http\Controllers\Admin\MasterQualificationController;
...
Route::post('/forgotPassword', [UserAuthController::class, 'forgotPassword'])->name('forgotPassword');
Route::get('/forgotPassword/otp', [UserAuthController::class, 'passwordForm'])->name('password.form');
Route::post('/newPassword', [UserAuthController::class, 'newPassword'])->name('newPassword');

Route::get('/setNewPassword', [UserAuthController::class, 'setNewpassordForm'])->name('newPassword.form');
Route::post('/setNewPassword', [UserAuthController::class, 'setPassword'])->name('setNewPassword');
Route::get('/success-password', [UserAuthController::class, 'passwordSuccess'])->name('passwordSuccess');
...
Route::middleware(['auth', 'role.group:admin'])->group(function () {
    ...
    Route::get('/roles/{role}/permissions', [RolesController::class, 'getPermissions']);
    Route::post('/roles/{role}/permissions', [RolesController::class, 'updatePermissions'])->name('roles.updatePermissions');
...
Route::get('/employee-dashboard', function () {
    ...
    Route::get('/tp-users/{status?}', [TPUsersController::class, 'index'])->name('tpusers');
    Route::get('/tp-users/data/{status?}', [TPUsersController::class, 'data'])->name(name: 'tpusers.data');
    Route::get('/tp-users/{tpuser}/show', [TPUsersController::class, 'show'])->name('tpusers.show');


    Route::get('/getPTFilesInZip/{tp_id}', [TPUsersController::class, 'makeZipWithFiles'])->name('tpusers.downloadFiles');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/leaves/admin', [App\Http\Controllers\Admin\LeaveController::class, 'adminIndex'])->name('leaves.admin_index');
});
...
Route::post('profile/update', [ProfileController::class, 'update'])->name('profile.update');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('admin/attendance/monthly/{year?}/{month?}', [AttendanceController::class, 'monthly'])
    ...
    Route::resource('master-equipment', MasterEquipmentController::class);
    Route::resource('master-qualification', MasterQualificationController::class);
    Route::resource('enduser-charge', EndUserChargeController::class);
    Route::resource('enduser-additional-data', EndUserAdditionalDataController::class);
});
