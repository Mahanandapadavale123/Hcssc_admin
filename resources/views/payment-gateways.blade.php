                                            ...
                                            <div
                                                ...
                                                <span
                                                    class="d-inline-flex align-items-center justify-content-center border rounded p-2"><img
                                                        src="{{ asset('admin/img/payment-gateway/payment-gateway-01.svg') }}"
                                                        alt="Img"></span>
                                    ...
                                    <div class="col-xxl-6 col-xl-6 d-flex">
                                        <div class="card mb-3 flex-fill">
                                            <div
                                                ...
                                                <span
                                                    class="d-inline-flex align-items-center justify-content-center border rounded p-2"><img
                                                        src="{{ asset('admin/img/payment-gateway/payment-gateway-02.svg') }}"
                                                        alt="Img"></span>
                                                <div class="d-flex align-items-center">
                                                    <div class="status-toggle modal-status">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 d-flex">
                                        <div class="card mb-3 flex-fill">
                                            <div
                                                ...
                                                <span
                                                    class="d-inline-flex align-items-center justify-content-center border rounded p-2"><img
                                                        src="{{ asset('admin/img/payment-gateway/payment-gateway-03.svg') }}"
                                                        alt="Img"></span>
                                                <div class="d-flex align-items-center">
                                                    <div class="status-toggle modal-status">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 d-flex">
                                        <div class="card mb-3 flex-fill">
                                            <div
                                                ...
                                                <span
                                                    class="d-inline-flex align-items-center justify-content-center border rounded p-2"><img
                                                        src="{{ asset('admin/img/payment-gateway/payment-gateway-04.svg') }}"
                                                        alt="Img"></span>
                                                <div class="d-flex align-items-center">
                                                    <div class="status-toggle modal-status">
