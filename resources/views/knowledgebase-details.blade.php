                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3 ps-4">
                            ...
                            <a href="javascript:void(0);" class="border-start text-gray fs-14 fw-normal ps-2 me-2"><img src="{{ asset('admin/img/users/user-38.jpg') }}" class="avatar avatar-xs me-2 flex-shrink-0" alt="Profile">Gertrude Bowie</a>
                        ...
                        <div class="col-lx-12 border-bottom mb-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        <span class="avatar avatar-lg me-2 flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-49.jpg') }}" class="rounded-circle" alt="Profile">
                                        </span>
                                        <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        <span class="avatar avatar-lg me-2 flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-55.jpg') }}" class="rounded-circle" alt="Profile">
                                        </span>
                                        <div>
