								...
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-39.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-01.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-02.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-03.jpg') }}" class="border border-white" alt="img">
											</span>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-40.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-04.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-05.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-06.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+2
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-41.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-07.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-08.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-09.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+2
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-42.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-10.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-11.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-12.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+2
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-43.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-45.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-13.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-14.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-15.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+3
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-46.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-16.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-17.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-18.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+3
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-47.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-19.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-20.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-21.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+2
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-48.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-22.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-23.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-24.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+2
											</a>
							...
							<div class="card-body">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-25.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-26.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-27.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+1
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-49.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-28.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-29.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-30.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+1
											</a>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="{{url('client-details')}}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset('admin/img/users/user-50.jpg') }}" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-31.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-32.jpg') }}" class="border border-white" alt="img">
											</span>
											<span class="avatar avatar-rounded">
												<img src="{{ asset('admin/img/users/user-33.jpg') }}" class="border border-white" alt="img">
											</span>
											<a class="avatar bg-primary avatar-rounded text-fixed-white fs-12" href="javascript:void(0);">
												+1
											</a>
