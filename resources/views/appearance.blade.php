                                                        ...
                                                        <div class="card-body">
                                                            <a href="#">
                                                                <div class="border rounded border-gray mb-2">
                                                                    <img src="{{ asset('admin/img/theme/light.svg') }}" class="img-fluid rounded" alt="theme">
                                                                </div>
                                                ...
                                                <div class="me-3">
                                                    <div class="card shadow-none">
                                                        <div class="card-body">
                                                            <a href="#">
                                                                <div class="border rounded border-gray mb-2">
                                                                    <img src="{{ asset('admin/img/theme/dark.svg') }}" class="img-fluid rounded" alt="theme">
                                                                </div>
                                                ...
                                                <div>
                                                    <div class="card shadow-none">
                                                        <div class="card-body">
                                                            <a href="#">
                                                                <div class="border rounded border-gray mb-2">
                                                                    <img src="{{ asset('admin/img/theme/automatic.svg') }}" class="img-fluid rounded" alt="theme">
                                                                </div>
