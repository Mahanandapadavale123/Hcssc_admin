            ...
            <div class="col-xl-6 d-flex">
                <div class="row flex-fill">
                    <div class="col-md-6 d-flex">
                        <div class="card flex-fill position-relative">
                            <span class="position-absolute start-0 bottom-0">
                                <img src="{{ asset('admin/img/reports-img/total-expense.svg') }}" alt="img" class="img-fluid">
                            </span>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 d-flex">
                        <div class="card flex-fill position-relative">
                            <span class="position-absolute start-0 bottom-0">
                                <img src="{{ asset('admin/img/reports-img/approved-expense.svg') }}" alt="img" class="img-fluid">
                            </span>
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div>
                    ...
                    <div class="col-md-6 d-flex">
                        <div class="card flex-fill position-relative">
                            <span class="position-absolute start-0 bottom-0">
                                <img src="{{ asset('admin/img/reports-img/pending-expense.svg') }}" alt="img" class="img-fluid">
                            </span>
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div>
                    ...
                    <div class="col-md-6 d-flex">
                        <div class="card flex-fill position-relative">
                            <span class="position-absolute start-0 bottom-0">
                                <img src="{{ asset('admin/img/reports-img/reject-expense.svg') }}" alt="img" class="img-fluid">
                            </span>
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div>
