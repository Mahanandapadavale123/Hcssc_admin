                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-03.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1"> Edgar Hansel</span>
                                    </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-01.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1">Ann Lynch</span>
                                    </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-06.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1">Juan Hermann</span>
                                    </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-05.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1">Jessie Otero</span>
                                    </p>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="{{ asset('admin/img/profiles/avatar-01.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img">Edgar Hansel
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">0</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="{{ asset('admin/img/profiles/avatar-02.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img">Ann Lynch
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">1</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="{{ asset('admin/img/profiles/avatar-03.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img">Juan Hermann
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">0</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="{{ asset('admin/img/profiles/avatar-04.jpg') }}" class="avatar avatar-xs rounded-circle me-2" alt="img">Jessie Otero
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">2</span>
                                    </div>
