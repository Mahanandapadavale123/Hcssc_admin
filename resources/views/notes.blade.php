                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                        <img src="{{ asset('admin/img/profiles/avatar-05.jpg') }}" alt="Profile"
                                    ...
                                    <div class="card rounded-3 mb-4 flex-fill">
                                        <div class="card-body p-4">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                        <img src="{{ asset('admin/img/profiles/avatar-06.jpg') }}" alt="Profile"
                                                            class="img-fluid rounded-circle">
                                                    </a>
                                                    <span class="text-success d-flex align-items-center"><i
                                                            class="fas fa-square square-rotate fs-10 me-1"></i>Work</span>
                                    ...
                                    <div class="card rounded-3 mb-4 flex-fill">
                                        <div class="card-body p-4">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                        <img src="{{ asset('admin/img/profiles/avatar-07.jpg') }}" alt="Profile"
                                                            class="img-fluid rounded-circle">
                                                    </a>
                                    ...
                                    <div class="card rounded-3 mb-4 flex-fill">
                                        <div class="card-body p-4">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                        <img src="{{ asset('admin/img/profiles/avatar-08.jpg') }}" alt="Profile"
                                                            class="img-fluid rounded-circle">
                                                    </a>
                                                    <span class="text-warning d-flex align-items-center"><i
                                                            class="fas fa-square square-rotate fs-10 me-1"></i>Social</span>
                                    ...
                                    <div class="card rounded-3 mb-4 flex-fill">
                                        <div class="card-body p-4">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                        <img src="{{ asset('admin/img/profiles/avatar-09.jpg') }}" alt="Profile"
                                                            class="img-fluid rounded-circle">
                                                    </a>
                                                    <span class="text-info d-flex align-items-center"><i
                                                            class="fas fa-square square-rotate fs-10 me-1"></i>Personal</span>
                                    ...
                                    <div class="card rounded-3 mb-4 flex-fill">
                                        <div class="card-body p-4">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                        <img src="{{ asset('admin/img/profiles/avatar-10.jpg') }}" alt="Profile"
                                                            class="img-fluid rounded-circle">
                                                    </a>
                                                    <span class="text-success d-flex align-items-center"><i
                                                            class="fas fa-square square-rotate fs-10 me-1"></i>Work</span>
