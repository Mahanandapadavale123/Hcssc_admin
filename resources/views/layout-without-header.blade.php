                ...
                <div class="card-body d-flex align-items-center justify-content-between flex-wrap pb-1">
                    <div class="d-flex align-items-center mb-3">
                        <span class="avatar avatar-xl flex-shrink-0">
                            <img src="{{ asset('admin/img/profiles/avatar-31.jpg') }}" class="rounded-circle" alt="img">
                        </span>
                        <div class="ms-3">
                            ...
                            <div class="p-2 d-flex align-items-center justify-content-between border border-primary bg-primary-100 br-5 mb-4">
                                <div class="d-flex align-items-center overflow-hidden">
                                    ...
                                    <a href="{{url('employee-details')}}" class="avatar avatar-md me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-24.jpg') }}" class="rounded-circle border border-white" alt="img">
                                    </a>
                                    <div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="avatar-list-stacked avatar-group-sm mb-2">
                                        <span class="avatar avatar-rounded">
                                            <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-27.jpg') }}" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded">
                                            <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-30.jpg') }}" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded">
                                            <img src="{{ asset('admin/img/profiles/avatar-14.jpg') }}" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded">
                                            <img src="{{ asset('admin/img/profiles/avatar-29.jpg') }}" alt="img">
                                        </span>
                        ...
                        <div class="card-body">
                            <div>
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                            <img src="{{ asset('admin/img/profiles/avatar-24.jpg') }}" class="rounded-circle border border-2" alt="img">
                                        </a>
                                        <div class="ms-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3 p-2 border br-5">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                            <img src="{{ asset('admin/img/profiles/avatar-23.jpg') }}" class="rounded-circle border border-2" alt="img">
                                        </a>
                                        <div class="ms-2">
                                ...
                                <div class="mb-3 p-2 border br-5">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                                <img src="{{ asset('admin/img/profiles/avatar-27.jpg') }}" class="rounded-circle border border-2" alt="img">
                                            </a>
                                            <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3 p-2 border border-dashed br-5">
                                <div class="d-flex align-items-center">
                                    <span class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/profiles/avatar-29.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </span>
                                    <div class="ms-2">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" id="openings">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar overflow-hidden flex-shrink-0 bg-gray-100">
                                                <img src="{{ asset('admin/img/icons/apple.svg') }}" class="img-fluid rounded-circle w-auto h-auto" alt="img">
                                            </a>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar overflow-hidden flex-shrink-0 bg-gray-100">
                                                <img src="{{ asset('admin/img/icons/php.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                                            </a>
                                            <div class="ms-2 overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar overflow-hidden flex-shrink-0 bg-gray-100">
                                                <img src="{{ asset('admin/img/icons/react.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                                            </a>
                                            <div class="ms-2 overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar overflow-hidden flex-shrink-0 bg-gray-100">
                                                <img src="{{ asset('admin/img/icons/laravel-icon.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                                            </a>
                                            <div class="ms-2 overflow-hidden">
                                ...
                                <div class="tab-pane fade show active" id="applicants">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar overflow-hidden flex-shrink-0">
                                                <img src="{{ asset('admin/img/users/user-09.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2 overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar overflow-hidden flex-shrink-0">
                                                <img src="{{ asset('admin/img/users/user-32.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2 overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar overflow-hidden flex-shrink-0">
                                                <img src="{{ asset('admin/img/users/user-34.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2 overflow-hidden">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="avatar">
                                                        <img src="{{ asset('admin/img/users/user-01.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="border-0">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar">
                                                        <img src="{{ asset('admin/img/users/user-37.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium"><a href="javascript:void(0);">Anthony Lewis</a></h6>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="px-0">
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('invoice-details')}}" class="avatar">
                                                        <img src="{{ asset('admin/img/users/user-39.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('invoice-details')}}" class="avatar">
                                                        <img src="{{ asset('admin/img/users/user-40.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('invoice-details')}}" class="avatar">
                                                        <img src="{{ asset('admin/img/users/user-55.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('invoice-details')}}" class="avatar">
                                                        <img src="{{ asset('admin/img/users/user-42.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('invoice-details')}}" class="avatar">
                                                        <img src="{{ asset('admin/img/users/user-44.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked avatar-group-sm">
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-02.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-03.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-05.jpg') }}" alt="img">
                                                    </span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked avatar-group-sm">
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-06.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-07.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-08.jpg') }}" alt="img">
                                                    </span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked avatar-group-sm">
                                                    ...
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-09.jpg') }}" alt="img">
                                                    </span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked avatar-group-sm">
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-11.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-12.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-13.jpg') }}" alt="img">
                                                    </span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked avatar-group-sm">
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-17.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-18.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-19.jpg') }}" alt="img">
                                                    </span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                <div class="avatar-list-stacked avatar-group-sm">
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-15.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-16.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-rounded">
                                                        <img class="border border-white" src="{{ asset('admin/img/profiles/avatar-17.jpg') }}" alt="img">
                                                    </span>
                        ...
                        <div class="card-body">
                            <div class="bg-light p-3 br-5 mb-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top mt-2 pt-3">
                                    <div class="avatar-list-stacked avatar-group-sm">
                                        <span class="avatar avatar-rounded">
                                            <img class="border border-white" src="{{ asset('admin/img/users/user-49.jpg') }}" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded">
                                            <img class="border border-white" src="{{ asset('admin/img/users/user-13.jpg') }}" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded">
                                            <img class="border border-white" src="{{ asset('admin/img/users/user-11.jpg') }}" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded">
                                            <img class="border border-white" src="{{ asset('admin/img/users/user-22.jpg') }}" alt="img">
                                        </span>
                                        <span class="avatar avatar-rounded">
                                            <img class="border border-white" src="{{ asset('admin/img/users/user-58.jpg') }}" alt="img">
                                        </span>
                                        <a class="avatar bg-primary avatar-rounded text-fixed-white fs-10 fw-medium" href="javascript:void(0);">
                                            +3
                                        </a>
                        ...
                        <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex align-items-center w-100">
                                        <a href="javscript:void(0);" class="avatar  flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-38.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                            ...
                            <div class="recent-item">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex align-items-center w-100">
                                        <a href="javscript:void(0);" class="avatar  flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-01.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2 flex-fill">
                                            <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="recent-item">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex align-items-center w-100">
                                        <a href="javscript:void(0);" class="avatar  flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-19.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2 flex-fill">
                                            <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="recent-item">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex align-items-center w-100">
                                        <a href="javscript:void(0);" class="avatar  flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-11.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2 flex-fill">
                                            <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="recent-item">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex align-items-center w-100">
                                        <a href="javscript:void(0);" class="avatar  flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-20.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2 flex-fill">
                                            <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="recent-item">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex align-items-center w-100">
                                        <a href="javscript:void(0);" class="avatar  flex-shrink-0">
                                            <img src="{{ asset('admin/img/users/user-08.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2 flex-fill">
                                            <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-body pb-1">
                            ...
                            <div class="bg-light p-2 border border-dashed rounded-top mb-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar">
                                            <img src="{{ asset('admin/img/users/user-10.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2 overflow-hidden">
                            ...
                            <div class="bg-light p-2 border border-dashed rounded-top mb-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar">
                                            <img src="{{ asset('admin/img/users/user-09.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                        <div class="ms-2 overflow-hidden">
                            ...
                            <div class="bg-light p-2 border border-dashed rounded-top mb-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar">
                                            <img src="{{ asset('admin/img/users/user-12.jpg') }}" class="rounded-circle" alt="img">
                                        </span>
                                        <div class="ms-2 overflow-hidden">
