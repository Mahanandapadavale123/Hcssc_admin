    ...
    <div class="page-wrapper job-wrapper ms-0">
        <div class="breadcrumb position-relative bg-secondary py-5">
            ...
            <div class="breadcrumb-bg">
                <span><img src="{{ asset('admin/img/bg/job-bg-01.png') }}" class="job-bg-01" alt="Img"></span>
                <span><img src="{{ asset('admin/img/bg/job-bg-02.png') }}" class="job-bg-02" alt="Img"></span>
                <span><img src="{{ asset('admin/img/bg/job-bg-03.png') }}" class="job-bg-03" alt="Img"></span>
                <span><img src="{{ asset('admin/img/bg/job-bg-04.png') }}" class="job-bg-04" alt="Img"></span>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="card-body">
                                ...
                                <ul>
                                    <li class="d-flex align-items-center mb-2">
                                        <img src="{{ asset('admin/img/icons/polygon-icon.svg') }}" class="me-1" alt="Img">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class="btn border btn-light-500 me-3"><img src="{{ asset('admin/img/social/google.svg') }}" alt="Img"></a>
                                <a href="#" class="btn border btn-light-500 me-3"><img src="{{ asset('admin/img/social/facebook.svg') }}" alt="Img"></a>
                                <a href="#" class="btn border btn-light-500 me-3"><img src="{{ asset('admin/img/social/twitter.svg') }}" alt="Img"></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card bg-light mb-3">
                                    <div class="card-body p-3">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="me-2">
                                                <span class="avatar avatar-lg bg-gray-100"><img src="{{ asset('admin/img/icons/apple.svg') }}" class="w-auto h-auto" alt="icon"></span>
                                            </a>
                                            <div>
