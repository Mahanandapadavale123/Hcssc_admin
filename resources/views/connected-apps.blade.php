                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-lg bg-gray-100 me-2 flex-shrink-0">
                                                    <img src="{{ asset('admin/img/settings/connected-app-01.svg') }}" class="w-auto h-auto" alt="Img">
                                                </span>
                                                <h5>Slack</h5>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-lg bg-gray-100 me-2 flex-shrink-0">
                                                    <img src="{{ asset('admin/img/settings/connected-app-02.svg') }}" class="w-auto h-auto" alt="Img">
                                                </span>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-lg bg-gray-100 me-2 flex-shrink-0">
                                                    <img src="{{ asset('admin/img/settings/connected-app-03.svg') }}" class="w-auto h-auto" alt="Img">
                                                </span>
                                                <h5>Gmail</h5>
                                            </div>
                                            <div class="form-check form-check-md form-switch">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-lg bg-gray-100 me-2 flex-shrink-0">
                                                    <img src="{{ asset('admin/img/settings/connected-app-04.svg') }}" class="w-auto h-auto" alt="Img">
                                                </span>
                                                <h5>Github</h5>
                                            </div>
                                            <div class="form-check form-check-md form-switch">
