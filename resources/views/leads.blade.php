                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="{{url('company-details')}}" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admin/img/company/company-06.svg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="{{url('company-details')}}" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admin/img/company/company-07.svg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="{{url('company-details')}}" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admin/img/company/company-08.svg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="{{url('company-details')}}" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admin/img/company/company-09.svg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="{{url('company-details')}}" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admin/img/company/company-10.svg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
