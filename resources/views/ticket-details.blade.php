                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="border-bottom mb-3 pb-3">
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex align-items-center mb-3">
                                            <span class="avatar avatar-lg avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('admin/img/users/user-09.jpg') }}" alt="Img"></span>
                                            <div>
                                ...
                                <div class="border-bottom mb-3 pb-3">
                                    <div>
                                        <div class="d-flex align-items-center mb-3">
                                            <span class="avatar avatar-ld avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('admin/img/users/user-02.jpg') }}" alt="Img"></span>
                                            <div>
                                ...
                                <div>
                                    <div>
                                        <div class="d-flex align-items-center mb-3">
                                            <span class="avatar avatar-lg avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('admin/img/profiles/avatar-22.jpg') }}" alt="Img"></span>
                                            <div>
                                                <h6 class="mb-1">Marilyn Siegle</h6>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="d-flex align-items-center border-bottom p-3">
                                <span class="avatar avatar-md me-2 flex-shrink-0"><img src="{{ asset('admin/img/users/user-01.jpg') }}" class="rounded-circle" alt="Img"></span>
                                <div>
                            ...
                            <div class="d-flex align-items-center border-bottom p-3">
                                <span class="avatar avatar-md me-2 flex-shrink-0"><img src="{{ asset('admin/img/users/user-05.jpg') }}" class="rounded-circle" alt="Img"></span>
                                <div>
