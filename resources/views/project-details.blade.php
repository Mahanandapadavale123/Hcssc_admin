                            ...
                            <div class="bg-light rounded p-3 mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                        <img src="{{ asset('admin/img/social/project-01.svg') }}" alt="Img">
                                    </a>
                                    <div>
                            ...
                            <div class="row align-items-center">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                                            <a href="#" class="avatar avatar-sm avatar-rounded border border-white flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/profiles/avatar-12.jpg') }}" alt="Img">
                                            </a>
                                            <h6 class="fs-12"><a href="#">Lewis</a></h6>
                                        </div>
                                        <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                                            <a href="#" class="avatar avatar-sm avatar-rounded border border-white flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/users/user-19.jpg') }}" alt="Img">
                                            </a>
                                        ...
                                        <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                                            <a href="#" class="avatar avatar-sm avatar-rounded border border-white flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/users/user-37.jpg') }}" alt="Img">
                                            </a>
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                                            <a href="#" class="avatar avatar-sm avatar-rounded border border-white flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/users/user-42.jpg') }}" alt="Img">
                                            </a>
                                            <h6 class="fs-12"><a href="#">Ruth</a></h6>
                                        </div>
                                        <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                                            <a href="#" class="avatar avatar-sm avatar-rounded border border-white flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/users/user-44.jpg') }}" alt="Img">
                                            </a>
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                                            <a href="#" class="avatar avatar-sm avatar-rounded border border-white flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/users/user-45.jpg') }}" alt="Img">
                                            </a>
                                ...
                                <div id="primaryBorderThree" class="accordion-collapse collapse show border-top" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="media-images-slider owl-carousel">
                                            <a href="{{ asset('admin/img/media/media-big-08.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                <img src="{{ asset('admin/img/media/media-08.jpg') }}" class=" rounded" alt="img">
                                            ...
                                            <a href="{{ asset('admin/img/media/media-big-09.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                <img src="{{ asset('admin/img/media/media-09.jpg') }}" class="rounded" alt="img">
                                                <div class="d-flex align-items-center hover-links">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-maximize"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-link"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-trash"></i></span>
                                            ...
                                            <a href="{{ asset('admin/img/media/media-big-10.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                <img src="{{ asset('admin/img/media/media-10.jpg') }}" class="rounded" alt="img">
                                                <div class="d-flex align-items-center hover-links">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-maximize"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-link"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-trash"></i></span>
                                            ...
                                            <a href="{{ asset('admin/img/media/media-big-11.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                <img src="{{ asset('admin/img/media/media-11.jpg') }}" class="rounded" alt="img">
                                                <div class="d-flex align-items-center hover-links">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-maximize"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-link"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-trash"></i></span>
                                            ...
                                            <a href="{{ asset('admin/img/media/media-big-12.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                <img src="{{ asset('admin/img/media/media-12.jpg') }}" class="rounded" alt="img">
                                                <div class="d-flex align-items-center hover-links">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-maximize"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-link"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-trash"></i></span>
                                            ...
                                            <a href="{{ asset('admin/img/media/media-big-13.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                <img src="{{ asset('admin/img/media/media-13.jpg') }}" class="rounded" alt="img">
                                                <div class="d-flex align-items-center hover-links">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-maximize"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-link"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-trash"></i></span>
                                            ...
                                            <a href="{{ asset('admin/img/media/media-big-14.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                <img src="{{ asset('admin/img/media/media-14.jpg') }}" class="rounded" alt="img">
                                                <div class="d-flex align-items-center hover-links">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-maximize"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-link"></i></span>
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-trash"></i></span>
                                            ...
                                            <div class="card shadow-none mb-0">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-2 pb-2 border-bottom">
                                                        <div class="d-flex align-items-center">
                                                            <a href="#" class="avatar avatar-md bg-light me-2">
                                                                <img src="{{ asset('admin/img/icons/file-02.svg') }}" class="w-auto h-auto" alt="img">
                                                            </a>
                                                            <div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <span class="avatar avatar-sm avatar-rounded"><img src="{{ asset('admin/img/profiles/avatar-02.jpg') }}" alt="Img"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card shadow-none mb-0">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-2 pb-2 border-bottom">
                                                        <div class="d-flex align-items-center">
                                                            <a href="#" class="avatar avatar-md bg-light me-2">
                                                                <img src="{{ asset('admin/img/icons/file-01.svg') }}" class="w-auto h-auto" alt="img">
                                                            </a>
                                                            <div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <p class="fw-medium mb-0">15 May 2024, 6:53 PM</p>
                                                        <span class="avatar avatar-sm avatar-rounded"><img src="{{ asset('admin/img/users/user-19.jpg') }}" alt="Img"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card shadow-none mb-0">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-2 pb-2 border-bottom">
                                                        <div class="d-flex align-items-center">
                                                            <a href="#" class="avatar avatar-md bg-light me-2">
                                                                <img src="{{ asset('admin/img/icons/file-04.svg') }}" class="w-auto h-auto" alt="img">
                                                            </a>
                                                            <div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <p class="fw-medium mb-0">15 May 2024, 6:53 PM</p>
                                                        <span class="avatar avatar-sm avatar-rounded"><img src="{{ asset('admin/img/users/user-20.jpg') }}" alt="Img"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
