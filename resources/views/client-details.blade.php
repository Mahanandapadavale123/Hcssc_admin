                    ...
                    <div class="card card-bg-1">
                        <div class="card-body p-0">
                            <span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2">
                                <img src="{{ asset('admin/img/users/user-13.jpg') }}" class="w-auto h-auto" alt="Img">
                            </span>
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="me-2"><img src="{{ asset('admin/img/social/social-01.svg') }}" alt="Img"></a>
                                    <a href="javascript:void(0);" class="me-2"><img src="{{ asset('admin/img/social/social-06.svg') }}" alt="Img"></a>
                                    <a href="javascript:void(0);" class="me-2"><img src="{{ asset('admin/img/social/social-02.svg') }}" alt="Img"></a>
                                    <a href="javascript:void(0);" class="me-2"><img src="{{ asset('admin/img/social/social-03.svg') }}" alt="Img"></a>
                                    <a href="javascript:void(0);" class="me-2"><img src="{{ asset('admin/img/social/social-04.svg') }}" alt="Img"></a>
                                    <a href="javascript:void(0);" class="me-2"><img src="{{ asset('admin/img/social/social-05.svg') }}" alt="Img"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <h6 class="fw-normal d-flex align-items-center">
                                                                                <img class="avatar avatar-xs rounded-circle me-1" src="{{ asset('admin/img/profiles/avatar-01.jpg') }}" alt="Img">
                                                                                Leona
                                                                            </h6>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col-xxl-6 col-lg-12 col-md-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                                                                    <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                                                        <img src="{{ asset('admin/img/social/project-02.svg') }}" alt="Img">
                                                                    </a>
                                                                    <div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="mb-3">
                                                                            <span class="mb-1 d-block">Project Lead</span>
                                                                            <h6 class="fw-normal d-flex align-items-center">
                                                                                <img class="avatar avatar-xs rounded-circle me-1" src="{{ asset('admin/img/profiles/avatar-02.jpg') }}" alt="Img">
                                                                                Mathis
                                                                            </h6>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                        <a href="#" class="avatar avatar-md bg-light"  data-bs-toggle="offcanvas" data-bs-target="#preview" >
                                                                            <img src="{{ asset('admin/img/icons/file-01.svg') }}" class="img-fluid"
                                                                                alt="img"></a>
                                                                        <div class="ms-2">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                        <a href="#" class="avatar avatar-md bg-light"  data-bs-toggle="offcanvas" data-bs-target="#preview" >
                                                                            <img src="{{ asset('admin/img/icons/file-02.svg') }}" class="img-fluid"
                                                                                alt="img"></a>
                                                                        <div class="ms-2">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                        <a href="#" class="avatar avatar-md bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview" >
                                                                            <img src="{{ asset('admin/img/icons/file-03.svg') }}" class="img-fluid"
                                                                                alt="img"></a>
                                                                        <div class="ms-2">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                        <a href="#" class="avatar avatar-md bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview" >
                                                                            <img src="{{ asset('admin/img/icons/file-04.svg') }}" class="img-fluid"
                                                                                alt="img"></a>
                                                                        <div class="ms-2">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                        <a href="#" class="avatar avatar-md bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview" >
                                                                            <img src="{{ asset('admin/img/icons/file-05.svg') }}" class="img-fluid"
                                                                                alt="img"></a>
                                                                        <div class="ms-2">
