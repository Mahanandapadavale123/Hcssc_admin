        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100 bg-primary-transparent">
                    <div>
                        <img src="{{asset('admin/img/bg/authentication-bg-07.svg')}}" alt="Img">
                    </div>
                </div>
            </div>
                            ...
                            <div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
                                ...
                                <div class="">
                                    <div class="text-center mb-3">
                                        <img src="{{asset('admin/img/icons/success-tick.svg')}}" alt="icon" class="img-fluid mb-3">
                                        <h2 class="mb-2">Success</h2>
                                        <p class="mb-0">Your new password has been successfully saved</p>
                                    </div>
                                    <div class="mb-3">
                                        <a href="{{  url('/login') }}" type="submit" class="btn btn-primary w-100">Back to Sign In</a>
                                    </div>
                                </div>
