        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="{{asset('admin/img/profiles/avatar-01.jpg')}}" class="avatar-xxl avatar bd-placeholder-img rounded" alt="img">
                        <img src="{{asset('admin/img/profiles/avatar-02.jpg')}}" class="avatar-xxl avatar  d-placeholder-img rounded-top" alt="img">
                        <img src="{{asset('admin/img/profiles/avatar-03.jpg')}}" class="avatar-xxl avatar bd-placeholder-img rounded-end" alt="img">
                        <img src="{{asset('admin/img/profiles/avatar-07.jpg')}}" class="avatar-xxl avatar bd-placeholder-img rounded-bottom" alt="img">
                        <img src="{{asset('admin/img/profiles/avatar-04.jpg')}}" class="avatar-xxl avatar bd-placeholder-img rounded-start" alt="img">
                        <img src="{{asset('admin/img/profiles/avatar-05.jpg')}}" class="avatar-xxl avatar bd-placeholder-img rounded-circle" alt="img">
                        <img src="{{asset('admin/img/profiles/avatar-06.jpg')}}" class="avatar-xxl avatar bd-placeholder-img  rounded-pill" alt="img">
                    </div>
                </div>
            </div>
            <!-- /Borders Radius -->
