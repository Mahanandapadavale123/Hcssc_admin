                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <span class="avatar avatar-xl avatar-rounded mb-2">
                                        <img src="{{ asset('admin/img/users/user-35.jpg') }}" alt="Img">
                                    </span>
                                    <div class="mb-3">
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/users/user-44.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/users/user-54.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                ...
                <div class="col-xl-4 d-flex">
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start mb-4">
                                <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                    <img src="{{ asset('admin/img/users/user-30.jpg') }}" class="rounded-circle border border-2" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to UNIX </h6>
