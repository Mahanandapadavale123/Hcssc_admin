                                    ...
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-xxl rounded me-3">
                                                <img src="{{ asset('admin/img/blog-2/blog-01.jpg') }}" class="rounded" alt="Img">
                                            </div>
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded me-2">
                                                        <img src="{{ asset('admin/img/users/user-29.jpg') }}" alt="Img">
                                                    </span>
                            ...
                            <div class="border-bottom mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-xxl rounded me-3">
                                                <img src="{{ asset('admin/img/blog-2/blog-02.jpg') }}" class="rounded" alt="Img">
                                            </div>
                                            <div>
                                                <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="border-bottom mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-xxl rounded me-3">
                                                <img src="{{ asset('admin/img/blog-2/blog-03.jpg') }}" class="rounded" alt="Img">
                                            </div>
                                            <div>
                                                <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="border-bottom mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-xxl rounded me-3">
                                                <img src="{{ asset('admin/img/blog-2/blog-04.jpg') }}" class="rounded" alt="Img">
                                            </div>
                                            <div>
                                                <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded me-2">
                                                        <img src="{{ asset('admin/img/users/user-22.jpg') }}" alt="Img">
                                                    </span>
                            ...
                            <div class="border-bottom mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-xxl rounded me-3">
                                                <img src="{{ asset('admin/img/blog-2/blog-05.jpg') }}" class="rounded" alt="Img">
                                            </div>
                                            <div>
                                                <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="border-bottom mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-xxl rounded me-3">
                                                <img src="{{ asset('admin/img/blog-2/blog-06.jpg') }}" class="rounded" alt="Img">
                                            </div>
                                            <div>
                                                <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded me-2">
                                                        <img src="{{ asset('admin/img/users/user-52.jpg') }}" alt="Img">
                                                    </span>
