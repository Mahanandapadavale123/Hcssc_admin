                            ...
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-04.svg') }}" alt="image"></a>
                        ...
                        <div>
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-07.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
                        ...
                        <div>
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-06.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
                        ...
                        <div>
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-05.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
                        ...
                        <div>
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-01.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
                        ...
                        <div>
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-08.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
                        ...
                        <div>
                            <div class="card kanban-card mb-0">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-09.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
                        ...
                        <div>
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-03.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
                        ...
                        <div>
                            <div class="card kanban-card">
                                <div class="card-body">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        <a href="javascript:void(0);" class="avatar avatar-sm  avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/company/company-02.svg') }}" alt="image"></a>
                                        <div class="icons-social d-flex align-items-center">
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-center me-2"><i
                                                    class="ti ti-phone-call"></i></a>
