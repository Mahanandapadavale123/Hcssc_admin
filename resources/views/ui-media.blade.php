                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{asset('admin/img/profiles/avatar-05.jpg')}}" class="avatar avatar-xl rounded" alt="...">
                            </div>
                        ...
                        <div class="d-flex align-items-start text-muted mb-4">
                            ...
                            <div class="flex-shrink-0 ms-3">
                                <img src="{{asset('admin/img/profiles/avatar-06.jpg')}}" class="avatar avatar-xl rounded" alt="...">
                            </div>
                        </div>
                        <div class="d-flex align-items-start text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{asset('admin/img/profiles/avatar-07.jpg')}}" class="avatar avatar-xl rounded" alt="...">
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="fs-14">Media Heading</h5>
                                This is some content from a media component. You can replace this with any content and adjust it as needed.
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{asset('admin/img/profiles/avatar-05.jpg')}}" class="avatar avatar-xxxl rounded" alt="...">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{asset('admin/img/profiles/avatar-06.jpg')}}" class="avatar avatar-xxxl rounded" alt="...">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-end text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{asset('admin/img/profiles/avatar-07.jpg')}}" class="avatar avatar-xxxl rounded" alt="...">
                            </div>
                            <div class="flex-grow-1">
