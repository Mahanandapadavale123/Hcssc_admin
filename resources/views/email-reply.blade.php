                        ...
                        <div class="slimscroll-active-sidebar">
                            <div class="p-3">
                                <div class="shadow-md bg-white rounded p-2 mb-4">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2">
                                            <img src="{{ asset('admin/img/profiles/avatar-02.jpg') }}" class="rounded-circle" alt="Img">
                                        </a>
                                        <div>
                                ...
                                <div class="bg-dark rounded text-center position-relative p-4">
                                    ...
                                    <div class="box-bg">
                                        <span class="bg-right"><img src="{{ asset('admin/img/bg/email-bg-01.png') }}" alt="Img"></span>
                                        <span class="bg-left"><img src="{{ asset('admin/img/bg/email-bg-02.png') }}" alt="Img"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-none">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center email-attach">
                                        <a href="{{ asset('admin/img/media/email-attach-big-01.jpg') }}" data-fancybox="gallery" class="avatar avatar-xl me-3 gallery-item">
                                            <img src="{{ asset('admin/img/media/email-attach-01.jpg') }}" class=" rounded" alt="img">
                                            <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                        </a>
                                        <a href="{{ asset('admin/img/media/email-attach-big-02.jpg') }}" data-fancybox="gallery" class="avatar avatar-xl me-3 gallery-item">
                                            <img src="{{ asset('admin/img/media/email-attach-02.jpg') }}" class="rounded" alt="img">
                                            <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                        </a>
                                        <a href="{{ asset('admin/img/media/email-attach-big-03.jpg') }}" data-fancybox="gallery" class="avatar avatar-xl me-3 gallery-item">
                                            <img src="{{ asset('admin/img/media/email-attach-03.jpg') }}" class="rounded" alt="img">
                                            <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                        </a>
                                    </div>
                                </div>
