                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-1.jpg')}}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-3.jpg')}}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-4.jpg')}}" alt="Third slide">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-2.jpg')}}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-4.jpg')}}" alt="Third slide">
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img src="{{asset('admin/img/img-1.jpg')}}" alt="Slide" class="d-block img-fluid">
                                ...
                                <div class="carousel-item">
                                    <img src="{{asset('admin/img/img-2.jpg')}}" alt="Slide" class="d-block img-fluid">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="{{asset('admin/img/img-3.jpg')}}" alt="Slide" class="d-block img-fluid">
                                    <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="card-body">
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-3.jpg')}}" alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-2.jpg')}}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="{{asset('admin/img/img-3.jpg')}}" alt="Second slide">
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{asset('admin/img/img-2.jpg')}}" class="d-block w-100" alt="Slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('admin/img/img-3.jpg')}}" class="d-block w-100" alt="Slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('admin/img/img-4.jpg')}}" class="d-block w-100" alt="Slide">
                                </div>
                            </div>
                        ...
                        <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <img src="{{asset('admin/img/img-2.jpg')}}" class="d-block w-100"
                                        alt="Slide">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{asset('admin/img/img-3.jpg')}}" class="d-block w-100"
                                        alt="Slide">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="{{asset('admin/img/img-4.jpg')}}" class="d-block w-100"
                                        alt="Slide">
                                    <div class="carousel-caption d-none d-md-block">
