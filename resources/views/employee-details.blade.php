                                                                ...
                                                                <div class="card-body">
                                                                    <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                                                                        <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin/img/social/project-03.svg') }}" alt="Img">
                                                                        </a>
                                                                        <div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div>
                                                                                ...
                                                                                <a href="#" class="fw-normal d-flex align-items-center">
                                                                                    <img class="avatar avatar-sm rounded-circle me-2" src="{{ asset('admin/img/profiles/avatar-01.jpg') }}" alt="Img">
                                                                                    Leona
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-8">
                                                                            <div class="d-flex align-items-center">
                                                                                <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                                                                    <img src="{{ asset('admin/img/products/product-05.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                                                </a>
                                                                                <div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-8">
                                                                            <div class="d-flex align-items-center">
                                                                                <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                                                                    <img src="{{ asset('admin/img/products/product-06.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                                                </a>
                                                                                <div>
