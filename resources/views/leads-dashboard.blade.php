                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card position-relative">
                        <div class="card-body">
                            ...
                            <span class="position-absolute top-0 end-0"><img src="{{ asset('admin/img/bg/card-bg-04.png') }}" alt="Img"></span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                            ...
                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/company/company-24.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/company/company-25.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/company/company-26.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/company/company-27.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/company/company-28.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/users/user-27.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/users/user-42.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/users/user-43.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/users/user-11.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                                        <h6 class="fs-14 fw-medium text-truncate mb-1"><a href="#">Daniel Esbella</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin/img/users/user-45.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                                        <h6 class="fs-14 fw-medium text-truncate mb-1"><a href="#">Doglas Martini</a></h6>
                                        <p class="fs-13">Team Lead</p>
                        ...
                        <div class="card-body schedule-timeline activity-timeline">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill ps-3 timeline-flow">
                                    <p class="fw-medium text-gray-9 mb-1"><a href="{{url('activity')}}" class="d-flex align-items-center">Meeting With <img src="{{ asset('admin/img/users/user-58.jpg') }}" class="avatar avatar-sm rounded-circle mx-2" alt="Img">Abraham</a></p>
                                    <span>09:25 PM</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start mb-4">
                                ...
                                <div class="ms-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="avatar avatar-sm border flex-shrink-0 me-2"><img src="{{ asset('admin/img/social/pdf-icon.svg') }}" class="w-auto h-auto" alt="Img"></a>
                            ...
                            <div class="d-flex align-items-start mb-4">
                                <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                    <img src="{{ asset('admin/img/users/user-28.jpg') }}" class="rounded-circle border border-2" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to UNIX </h6>
                            ...
                            <div class="d-flex align-items-start mb-4">
                                <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                    <img src="{{ asset('admin/img/users/user-29.jpg') }}" class="rounded-circle border border-2" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to UNIX </h6>
                            ...
                            <div class="d-flex align-items-start">
                                <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                    <img src="{{ asset('admin/img/users/user-33.jpg') }}" class="rounded-circle border border-2" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to UNIX </h6>
                                    ...
                                    <div class="pe-3 border-end">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ asset('admin/img/payment-gateway/country-03.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ asset('admin/img/payment-gateway/country-04.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ asset('admin/img/payment-gateway/country-05.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ asset('admin/img/payment-gateway/country-01.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ asset('admin/img/payment-gateway/country-02.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                                        <img src="{{ asset('admin/img/company/company-01.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                                        <img src="{{ asset('admin/img/company/company-02.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                                        <img src="{{ asset('admin/img/company/company-03.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                                        <img src="{{ asset('admin/img/company/company-04.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                                        <img src="{{ asset('admin/img/company/company-05.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
