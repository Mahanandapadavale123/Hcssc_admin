                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="d-flex align-items-center fw-medium">
                                                        <img src="{{ asset('admin/img/flags/ae.png') }}" class="me-2 avatar avatar-sm avatar-rounded" alt="Img">
                                                        Arabic
                                                    </h6>
                                                </td>
                                                <td>en</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="d-flex align-items-center fw-medium">
                                                        <img src="{{ asset('admin/img/flags/cn.png') }}" class="me-2 avatar avatar-sm avatar-rounded" alt="Img">
                                                        Chinese
                                                    </h6>
                                                </td>
                                                <td>zh</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="d-flex align-items-center fw-medium">
                                                        <img src="{{ asset('admin/img/flags/us.png') }}" class="me-2 avatar avatar-sm avatar-rounded" alt="Img">
                                                        English
                                                    </h6>
                                                </td>
                                                <td>en</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="d-flex align-items-center fw-medium">
                                                        <img src="{{ asset('admin/img/flags/in.png') }}" class="me-2 avatar avatar-sm avatar-rounded" alt="Img">
                                                        Hindi
                                                    </h6>
                                                </td>
                                                <td>hi</td>
