                                                ...
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img  src="{{ asset('admin/img/settings/nexmo.svg') }}" alt="Profile">
                                                            </span>
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img  src="{{ asset('admin/img/settings/sms-gateway.svg') }}" alt="Profile">
                                                            </span>
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img src="{{ asset('admin/img/settings/twilio.svg') }}" alt="Profile">
                                                            </span>
