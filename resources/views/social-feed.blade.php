                            ...
                            <div class="bg-light rounded p-3 mb-4">
                                <div class="text-center mb-3">
                                    <a href="javascript:void(0);" class="avatar avatar-xl online avatar-rounded">
                                        <img src="{{ asset('admin/img/users/user-11.jpg') }}" alt="Img">
                                    </a>
                                ...
                                <div>
                                    <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                        <span class="d-inline-flex align-items-center">
                                            <img src="{{ asset('admin/img/icons/liked-page-01.svg') }}" class="me-2" alt="Img">Dribble
                                        </span>
                                        <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                    </a>
                                    <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                        <span class="d-inline-flex align-items-center">
                                            <img src="{{ asset('admin/img/icons/liked-page-02.svg') }}" class="me-2" alt="Img">UI/UX Designs
                                        </span>
                                        <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                    </a>
                                    <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1">
                                        <span class="d-inline-flex align-items-center">
                                            <img src="{{ asset('admin/img/icons/liked-page-03.svg') }}" class="me-2" alt="Img">Figma Update
                                        </span>
                                        <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                    </a>
                                    <div>
                                        <div class="more-menu-3">
                                            <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                                <span class="d-inline-flex align-items-center">
                                                    <img src="{{ asset('admin/img/icons/liked-page-04.svg') }}" class="me-2" alt="Img">I Am Techie
                                                </span>
                                                <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                            </a>
                                        </div>
                    ...
                    <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="channels-slider owl-carousel">
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-01.svg') }}" alt="Img">
                                    </a>
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-02.svg') }}" alt="Img">
                                    </a>
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-03.svg') }}" alt="Img">
                                    </a>
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-04.svg') }}" alt="Img">
                                    </a>
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-05.svg') }}" alt="Img">
                                    </a>
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-06.svg') }}" alt="Img">
                                    </a>
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-07.svg') }}" alt="Img">
                                    </a>
                                    <a href="javascript:void(0);">
                                        <img src="{{ asset('admin/img/icons/channel-08.svg') }}" alt="Img">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/users/user-03.jpg') }}" alt="Img"></a>
                                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <img src="{{ asset('admin/img/social/social-feed-01.jpg') }}" class="rounded" alt="Img">
                                </div>
                                <div class="social-gallery-slider owl-carousel mb-3">
                                    <a href="{{ asset('admin/img/social/gallery-big-01.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ asset('admin/img/social/gallery-01.jpg') }}" class="rounded" alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ asset('admin/img/social/gallery-big-02.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ asset('admin/img/social/gallery-02.jpg') }}" class="rounded" alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ asset('admin/img/social/gallery-big-03.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ asset('admin/img/social/gallery-03.jpg') }}" class="rounded" alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ asset('admin/img/social/gallery-big-04.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ asset('admin/img/social/gallery-04.jpg') }}" class="rounded" alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ asset('admin/img/social/gallery-big-01.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ asset('admin/img/social/gallery-01.jpg') }}" class="rounded" alt="img">
                                ...
                                <div class="d-flex align-items-start">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('admin/img/users/user-11.jpg') }}" alt="Img"></a>
                        ...
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/users/user-05.jpg') }}" alt="Img"></a>
                                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card shadow-none mb-3">
                                    <div class="card-img card-img-hover rounded-0">
                                        <a href="javascript:void(0);" class="rounded-top"><img src="{{ asset('admin/img/social/social-feed-02.jpg') }}" class="rounded-top" alt="Img"></a>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('admin/img/users/user-04.jpg') }}" alt="Img"></span>
                                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <img src="{{ asset('admin/img/social/social-feed-03.jpg') }}" class="rounded" alt="Img">
                                </div>
                                <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                    <div class="d-flex align-items-center flex-wrap row-gap-3">
                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3">
                                ...
                                <div class="d-flex align-items-start mb-3">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-02.jpg') }}" alt="Img">
                                    </a>
                                ...
                                <div class="d-flex align-items-start mb-3 ms-4 ps-2">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-01.jpg') }}" alt="Img">
                                    </a>
                                    <div class="bg-light rounded flex-fill p-2">
                                        <div class="d-flex align-items-center mb-1">
                                ...
                                <div class="d-flex align-items-start mb-3">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                        <img src="{{ asset('admin/img/profiles/avatar-04.jpg') }}" alt="Img">
                                    </a>
                                    <div class="bg-light rounded flex-fill p-2">
                                        <div class="d-flex align-items-center mb-1">
                                ...
                                <div>
                                    <div class="more-menu">
                                        <div class="d-flex align-items-start mb-3">
                                            <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/profiles/avatar-05.jpg') }}" alt="Img">
                                            </a>
                                            <div class="bg-light rounded flex-fill p-2">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5><a href="javascript:void(0);">Samuel Butler</a></h5>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/img/profiles/avatar-06.jpg') }}" alt="Img">
                                            </a>
                                            <div class="bg-light rounded flex-fill p-2">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5><a href="javascript:void(0);">Samuel Butler</a></h5>
                                ...
                                <div class="d-flex align-items-start">
                                    <span class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('admin/img/users/user-11.jpg') }}" alt="Img"></span>
                                    <input type="text" class="form-control" placeholder="Enter Comments">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-01.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-33.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-34.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-09.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-02.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel">
                                    <div>
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/profiles/avatar-11.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                                        <a href="javascript:void(0);">Anthony Lewis</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-12.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                                        <a href="javascript:void(0);">Harvey Smith</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-13.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                                        <a href="javascript:void(0);">Stephan Peralt</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-14.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                                        <a href="javascript:void(0);">Doglas Martini</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-15.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                                        <a href="javascript:void(0);">Brian Villalobos</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admin/img/users/user-16.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium mb-1">
                                                        <a href="javascript:void(0);">Linda Ray</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="bg-light-500 rounded p-2 mb-2">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span><img src="{{ asset('admin/img/icons/feeds-01.svg') }}" class="me-2" alt="Img"></span>
                            ...
                            <div class="bg-light-500 rounded p-2 mb-2">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span><img src="{{ asset('admin/img/icons/feeds-02.svg') }}" class="me-2" alt="Img"></span>
                            ...
                            <div class="bg-light-500 rounded p-2 mb-2">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span><img src="{{ asset('admin/img/icons/feeds-03.svg') }}" class="me-2" alt="Img"></span>
                            ...
                            <div class="bg-light-500 rounded p-2">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span><img src="{{ asset('admin/img/icons/feeds-04.svg') }}" class="me-2" alt="Img"></span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-img card-img-hover mb-3">
                                <a href="javascript:void(0);" class="rounded"><img src="{{ asset('admin/img/social/social-feed-04.jpg') }}" class="rounded" alt="Img"></a>
                            </div>
