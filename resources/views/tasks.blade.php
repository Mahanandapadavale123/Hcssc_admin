                    ...
                    <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            <span class="mb-1 d-block">Project Lead</span>
                                            <h6 class="fw-normal d-flex align-items-center">
                                                <img class="avatar avatar-xs rounded-circle me-1" src="{{ asset('admin/img/profiles/avatar-06.jpg') }}" alt="Img">
                                                Harvey Smith
                                            </h6>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                                    <a href="{{url('task-details')}}" class="flex-shrink-0 me-2">
                                        <img src="{{ asset('admin/img/social/project-04.svg') }}" alt="Img">
                                    </a>
                                    <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            <span class="mb-1 d-block">Project Lead</span>
                                            <h6 class="fw-normal d-flex align-items-center">
                                                <img class="avatar avatar-xs rounded-circle me-1" src="{{ asset('admin/img/profiles/avatar-27.jpg') }}" alt="Img">
                                                Stephan Peralt
                                            </h6>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                                    <a href="{{url('task-details')}}" class="flex-shrink-0 me-2">
                                        <img src="{{ asset('admin/img/social/project-05.svg') }}" alt="Img">
                                    </a>
                                    <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            <span class="mb-1 d-block">Project Lead</span>
                                            <h6 class="fw-normal d-flex align-items-center">
                                                <img class="avatar avatar-xs rounded-circle me-1" src="{{ asset('admin/img/profiles/avatar-23.jpg') }}" alt="Img">
                                                Doglas Martini
                                            </h6>
                                        </div>
                                    </div>
