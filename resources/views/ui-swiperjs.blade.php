                    ...
                    <div class="card-body">
                        <div class="swiper swiper-basic">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img src="{{ asset('admin/img/img-01.jpg') }}" alt="Img"></div>
                                <div class="swiper-slide"><img src="{{ asset('admin/img/img-02.jpg') }}" alt="Img"></div>
                                <div class="swiper-slide"><img src="{{ asset('admin/img/img-03.jpg') }}" alt="Img"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="swiper pagination">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img src="{{ asset('admin/img/img-04.jpg') }}" alt="Img"></div>
                                <div class="swiper-slide"><img src="{{ asset('admin/img/img-05.jpg') }}" alt="Img"></div>
                                <div class="swiper-slide"><img src="{{ asset('admin/img/img-01.jpg') }}" alt="Img"></div>
                            </div>
