                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center file-name-icon">
                                        <a href="#" class="avatar avatar-md border avatar-rounded">
                                            <img src="{{ asset('admin/img/users/user-32.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                        <div class="ms-2">
                                ...
                                <td>
                                    ...
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-09.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-47.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-44.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked avatar-group-sm">
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-17.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-08.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-18.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar group-counts bg-primary rounded-circle border-0 fs-10">
                                        +3
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked avatar-group-sm">
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-21.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-22.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-33.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar group-counts bg-primary rounded-circle border-0 fs-10">
                                        +1
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked avatar-group-sm">
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-16.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-26.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-35.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar group-counts bg-primary rounded-circle border-0 fs-10">
                                        +3
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-36.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-10.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar group-counts bg-primary rounded-circle border-0 fs-10">
                                        +4
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked avatar-group-sm">
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-11.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-19.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-20.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar group-counts bg-primary rounded-circle border-0 fs-10">
                                        +5
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center file-name-icon">
                                        <a href="#" class="avatar avatar-md border avatar-rounded">
                                            <img src="{{ asset('admin/img/users/user-22.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                        <div class="ms-2">
                                ...
                                <td>
                                    <div class="avatar-list-stacked avatar-group-sm">
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-14.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-29.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-22.jpg') }}" class="rounded-circle"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-38.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-42.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar group-counts bg-primary rounded-circle border-0 fs-10">
                                        +2
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-02.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-40.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar group-counts bg-primary rounded-circle border-0 fs-10">
                                        +1
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked avatar-group-sm">
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-13.jpg') }}" class="rounded-circle"
                                            alt="img">
                                    </span>
                                    <span class="avatar border-0">
                                        <img src="{{ asset('admin/img/users/user-11.jpg') }}" class="rounded-circle"
