                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('admin/img/icons/dropbox.svg') }}" alt="img">
                ...
                <div class="col-lg-3 col-md-6 d-flex">
                    <div class="card bg-lightpink-gradient flex-fill">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('admin/img/icons/drive.svg') }}" alt="img">
                ...
                <div class="col-lg-3 col-md-6 d-flex">
                    <div class="card bg-lightsuccess-gradient flex-fill">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('admin/img/icons/cloud.svg') }}" alt="img">
                ...
                <div class="col-lg-3 col-md-6 d-flex">
                    <div class="card bg-lightpurple-gradient flex-fill">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('admin/img/icons/storage.svg') }}" alt="img">
                ...
                <div class="col-xl-3  theiaStickySidebar">
                            ...
                            <div class="shadow-xs p-2 mb-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center overflow-hidden">
                                        <span class="avatar">
                                            <img src="{{ asset('admin/img/profiles/avatar-29.jpg') }}" alt="img" class="rounded-circle">
                                        </span>
                    ...
                    <div class="card bg-black bg-01">
                        <div class="card-body text-center">
                            <img src="{{ asset('admin/img/icons/upgrade.svg') }}" alt="img" class="mb-3">
                        ...
                        <div class="row row-cols-xxl-5 row-cols-xl-3 row-cols-sm-3 row-cols-1 justify-content-center">
                            <div class="col d-flex">
                                <div class="card access-wrap border-0 flex-fill">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('admin/img/icons/file.svg') }}" alt="img" class="mb-3">
                            ...
                            <div class="col d-flex">
                                <div class="card access-wrap border-0 flex-fill">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('admin/img/icons/pdf-icon.svg') }}" alt="img" class="mb-3">
                            ...
                            <div class="col d-flex">
                                <div class="card access-wrap border-0 flex-fill">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('admin/img/icons/image.svg') }}" alt="img" class="mb-3">
                            ...
                            <div class="col d-flex">
                                <div class="card access-wrap border-0 flex-fill">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('admin/img/icons/xls-icon.svg') }}" alt="img" class="mb-3">
                            ...
                            <div class="col d-flex">
                                <div class="card access-wrap border-0 flex-fill">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('admin/img/icons/folder-icon.svg') }}" alt="img" class="mb-3">
                    ...
                    <div class="border-bottom mb-4">
                        ...
                        <div class="owl-carousel video-section">
                            <div class="video-wrap">
                                <video width="100" height="100" class="js-player" crossorigin playsinline poster="{{ asset('admin/img/file-manager/video-01.jpg') }}">
                            ...
                            <div class="video-wrap">
                                <video width="100" height="100" class="js-player" crossorigin playsinline poster="{{ asset('admin/img/file-manager/video-02.jpg') }}">
                                    <source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4" type="video/mp4">
                                </video>
                                <div class="d-flex align-items-center justify-content-between video-content">
                            ...
                            <div class="video-wrap">
                                <video width="100" height="100" class="js-player" crossorigin playsinline poster="{{ asset('admin/img/file-manager/video-03.jpg') }}">
                                    <source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4" type="video/mp4">
                                </video>
                                <div class="d-flex align-items-center justify-content-between video-content">
