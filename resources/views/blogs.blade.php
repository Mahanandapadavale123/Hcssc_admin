                        ...
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-01.jpg') }}"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-02.jpg') }}"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-02.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-03.jpg') }}"
                                            class="avatar avatar-xs rounded-circle me-2 flex-shrink-0"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-03.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-05.jpg') }}"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-04.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-04.jpg') }}"
                                            class="avatar avatar-xs rounded-circle me-2 flex-shrink-0"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-05.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-06.jpg') }}"
                                            class="avatar avatar-xs rounded-circle me-2 flex-shrink-0"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-06.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-08.jpg') }}"
                                            class="avatar avatar-xs rounded-circle me-2 flex-shrink-0"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-07.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-07.jpg') }}"
                                            class="avatar avatar-xs rounded-circle me-2 flex-shrink-0"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-08.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                                    <span class="trend-tag badge bg-info-transparent fs-10 fw-medium">Management</span>
                                    <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-10.jpg') }}"
                                            class="avatar avatar-xs rounded-circle me-2 flex-shrink-0"
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="img-sec w-100 position-relative mb-3">
                                <a href="{{ url('blog-categories') }}"><img
                                        src="{{ asset('admin/img/blogs/blog-09.jpg') }}"
                                        class="img-fluid rounded w-100" alt="img"></a>
                                <div class="">
                                    <span class="trend-tag badge bg-info-transparent fs-10 fw-medium">Management</span>
                                    <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"><img
                                            src="{{ asset('admin/img/users/user-09.jpg') }}"
                                            class="avatar avatar-xs rounded-circle me-2 flex-shrink-0"
