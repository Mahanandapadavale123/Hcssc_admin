    ...
    @endcomponent
        ...
        <div class="row">
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <img src="{{asset('admin/img/img-01.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <img src="{{asset('admin/img/img-02.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <img src="{{asset('admin/img/img-03.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6 class="card-title fw-semibold">Card title</h6>
                        <p class="card-text">Some quick example text to build on the card title and
                            make up the bulk of the card's content.</p>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-12">
                ...
                <div class="row row-cols-12">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{asset('admin/img/img-04.jpg')}}" class="card-img mb-3" alt="...">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{asset('admin/img/img-05.jpg')}}" class="card-img mb-3" alt="...">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{asset('admin/img/img-02.jpg')}}" class="card-img mb-3" alt="...">
                            ...
                            <div class="card-body">
                                <div class="mb-2">
                                    <span class="avatar avatar-md">
                                        <img src="{{asset('admin/img/img-01.jpg')}}" alt="img">
                                    </span>
                                </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card text-center">
                            <div class="card-body">
                                <div class="mb-2">
                                    <span class="avatar avatar-md">
                                        <img src="{{asset('admin/img/img-02.jpg')}}" alt="img">
                                    </span>
                                </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card text-end">
                            <div class="card-body">
                                <div class="mb-2">
                                    <span class="avatar avatar-md">
                                        <img src="{{asset('admin/img/img-03.jpg')}}" alt="img">
                                    </span>
                                </div>
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center w-100">
                            <img src="{{asset('admin/img/profiles/avatar-01.jpg')}}" alt="img" class="avatar avatar-rounded me-2">
                            <div class="">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body pt-1">
                        <span class="avatar avatar-xl avatar-rounded me-2 mb-2">
                            <img src="{{asset('admin/img/profiles/avatar-07.jpg')}}" alt="img">
                        </span>
            ...
            <div class="col-xl-2">
                <div class="card">
                    <div class="card-body">
                        <img src="{{asset('admin/img/img-1.jpg')}}" class="card-img mb-3" alt="...">
            ...
            <div class="col-xl-2">
                <div class="card">
                    <div class="card-body">
                        <img src="{{asset('admin/img/img-2.jpg')}}" class="card-img mb-3" alt="...">
            ...
            <div class="col-xl-2">
                <div class="card">
                    <div class="card-body">
                        <img src="{{asset('admin/img/img-3.jpg')}}" class="card-img mb-3" alt="...">
                        ...
                        <div class="d-flex w-100">
                            <div class="me-4">
                                <span class="avatar avatar-lg avatar-rounded">
                                    <img src="{{asset('admin/img/profiles/avatar-03.jpg')}}" alt="img">
                                </span>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <img src="{{asset('admin/img/img-02.jpg')}}" class="card-img-bottom" alt="...">
                </div>
            </div>
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <img src="{{asset('admin/img/img-2.jpg')}}" class="card-img rounded-0" alt="...">
                    <div class="card-body">
                        <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                    </div>
                </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <img src="{{asset('admin/img/img-04.jpg')}}" class="card-img rounded-0" alt="...">
                    <div class="card-footer">
                        <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                    </div>
                </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <img src="{{asset('admin/img/img-05.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-header">
                        <div class="card-title">Image caps are widely used in Blog's</div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <img src="{{asset('admin/img/img-1.jpg')}}" class="card-img-bottom" alt="...">
                </div>
            </div>
        </div>
        <!-- /Image Caps -->
        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card overlay-card">
                    <img src="{{asset('admin/img/img-2.jpg')}}" class="card-img" alt="...">
            ...
            <div class="col-xl-4">
                <div class="card overlay-card">
                    <img src="{{asset('admin/img/img-3.jpg')}}" class="card-img" alt="...">
            ...
            <div class="col-xl-4">
                <div class="card overlay-card">
                    <img src="{{asset('admin/img/img-4.jpg')}}" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column p-0">
                        <div class="card-header">
                            <div class="card-title text-fixed-white">
                                Image Overlays Are Awesome!
        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset('admin/img/img-05.jpg')}}" class="img-fluid rounded-start object-fit-cover h-100 w-100" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-header">
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="row g-0">
                        ...
                        <div class="col-md-4">
                            <img src="{{asset('admin/img/img-01.jpg')}}" class="img-fluid rounded-end object-fit-cover h-100 w-100" alt="...">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4">
                <div class="card">
                    <div class="row g-0">
                        ...
                        <div class="col-md-4">
                            <img src="{{asset('admin/img/img-02.jpg')}}" class="img-fluid rounded-end object-fit-cover h-100 w-100" alt="...">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border border-warning">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            ...
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-08.jpg')}}" alt="img">
                            </span>
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-09.jpg')}}" alt="img">
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3">
                <div class="card border border-info">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-10.jpg')}}" alt="img">
                            </span>
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-11.jpg')}}" alt="img">
                            </span>
            ...
            <div class="col-xl-3">
                <div class="card border border-danger">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-13.jpg')}}" alt="img">
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border border-success">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            ...
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-15.jpg')}}" alt="img">
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3">
                <div class="card border border-light">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-16.jpg')}}" alt="img">
                            </span>
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-17.jpg')}}" alt="img">
                            </span>
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{asset('admin/img/profiles/avatar-18.jpg')}}" alt="img">
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xxl-3 col-xl-12">
                <div class="card">
                    ...
                    <img src="{{asset('admin/img/img-1.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
                    ...
                    <div class="col-xxl-7 col-xl-12">
                        <div class="card">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-4">
                                    <img src="{{asset('admin/img/img-5.jpg')}}" class="img-fluid rounded-end object-fit-cover h-100" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-6">
                <div class="card">
                    <a href="javascript:void(0);" class="card-anchor"></a>
                    <img src="{{asset('admin/img/img-4.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="row row-cols-1 row-cols-md-4 g-4">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="{{asset('admin/img/img-04.jpg')}}" class="card-img-top" alt="...">
                            <div class="card-body">
