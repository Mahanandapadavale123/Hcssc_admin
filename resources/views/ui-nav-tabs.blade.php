                                   ...
                                   <table class="table mb-0">
                                       ...
                                       <tbody>
                                           <tr>
                                               <th scope="row">
                                                   <span class="avatar avatar-sm">
                                                       <img src="{{asset('admin/img/products/product-01.jpg')}}" alt="img">
                                                   </span>
                                               </th>
                                               <td>Wrist Watch</td>
                                               <td>Watch</td>
                                           ...
                                           <tr>
                                               <th scope="row">
                                                   <span class="avatar avatar-sm">
                                                       <img src="{{asset('admin/img/products/product-02.jpg')}}" alt="img">
                                                   </span>
                                               </th>
                                               <td>Camera</td>
                                               <td>Gadgets</td>
                                           ...
                                           <tr>
                                               <th scope="row">
                                                   <span class="avatar avatar-sm">
                                                       <img src="{{asset('admin/img/products/product-03.jpg')}}" alt="img">
                                                   </span>
                                               </th>
                                               <td>Shoes</td>
                                               <td>Footwear</td>
